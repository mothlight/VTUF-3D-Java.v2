...
public final class BinaryIn 
{
   ...
   /**
     ...
     * @throws NoSuchElementException if there are fewer than 32 bits available
     */
    public int getInt(Character[] data, boolean bigEndian) 
    {
    	if (bigEndian)
    	{
            int x = 0;
    	...
    	{
            int x = 0;
            char[] reversedData = new char[4];
            for (int i = 0; i < 4; i++) 
            {
            	int count = -1*i + 7;
            	reversedData[count] = data[i];
            }
            for (int i = 0; i < 4; i++) 
            {
                char c = reversedData[i];
                x <<= 8;
                x |= c;
            }
            return x;
   ...
   /**
     ...
     * @throws NoSuchElementException if there are fewer than 64 bits available
     */
    public long getLong(Character[] data, boolean bigEndian) 
    {
    	if (bigEndian)
    	{
            long x = 0;
   ...
   /**
     ...
     * @throws NoSuchElementException if there are fewer than 64 bits available
     */
    public double getDouble(Character[] data, boolean bigEndian) 
    {
        return Double.longBitsToDouble(getLong(data, bigEndian));
    }
   ...
   /**
     ...
     * @throws NoSuchElementException if there are fewer than 32 bits available
     */
    public float getFloat(Character[] data, boolean bigEndian) 
    {
        return Float.intBitsToFloat(getInt(data, bigEndian));
    }

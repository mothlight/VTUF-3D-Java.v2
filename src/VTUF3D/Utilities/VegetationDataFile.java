...
public class VegetationDataFile
{
...
//		data.test();
		...
		data = new VegetationDataFile(file, 21);
		data.test2();

	}
	
	public VegetationDataFile(String file)
	{
		super();
		readDataFile(file);
	}
	
	public VegetationDataFile(String file, int skipLines)
	{
		super();
